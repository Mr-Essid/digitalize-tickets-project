...
use App\Http\Resources\SubscriptionXResource;
...
class ClientManageSubscription extends Controller
{
    ...
    function getSubscriptionX($subscriptionX)
    {
        $subscriptionX_ = ClientSubscription::find($subscriptionX);

        return new SubscriptionXResource($subscriptionX_);
    }
}
